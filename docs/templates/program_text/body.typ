...
#h(2em) Программа, представляющая собой реализацию основных операций слоёв сверточных нейронных моделей на мобильных устройствах Apple. Ознакомиться с текстом программы можно на сайте Github по ссылке: https://github.com/gsukhanov/apple-fast-inference/
