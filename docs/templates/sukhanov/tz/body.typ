...
#h(4em) 1. Реализация индивидуального компонента должна обеспечивать возможность измерения времени исполнения и сравнения с базовой CPU-реализацией. \
#h(4em) 2. Время обработки одного изображения или одной операции должно быть измеряемо, протоколируемо и воспроизводимо для каждой комбинации разрядности и режима вычислений (CPU/AMX), относящейся к индивидуальной части. \
...
#h(4em) Исходный код индивидуальной части программы должен быть реализован на языке C++ [14] с использованием фреймворка Accelerate [15] для AMX-реализации и с использованием векторного расширения ARM NEON для CPU-реализации, если это требуется индивидуальным направлением.
...
#h(2em) Индивидуальная часть "#personal.work_title" обеспечивает получение отдельного результата, необходимого для общей оценки эффективности CPU и AMX.
...
#let stage_table_align = (center + horizon, center + horizon, left + horizon, center + horizon)
#let stage_table_inset = (x: 2pt, y: 2pt)
...
#figure(
    table(
        ...
        [1. Проектирование индивидуального компонента: #personal.task_1], [16.12.25 --\ 15.01.26],
        [2. Реализация базовых структур и проверок: #personal.task_2], [16.01.26 --\ 31.01.26],
        [3. Реализация вычислительного пути: #personal.task_3], [01.02.26 --\ 28.02.26],
        [4. Интеграция оптимизированного режима: #personal.task_4], [01.03.26 --\ 20.03.26],
        [5. Проверка корректности индивидуальной реализации: #personal.task_5], [21.03.26 --\ 03.04.26],
    ),
)
