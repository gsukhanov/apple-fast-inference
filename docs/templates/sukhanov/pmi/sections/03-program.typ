...
#paragraph[
  TODO: вставить скриншоты консольного вывода результатов бенчмарков и сравнения точности.
]

#paragraph[
  TODO: вставить графики сравнения производительности CPU и AMX режимов.
]
