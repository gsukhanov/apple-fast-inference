...
+ Измерение производительности и точности
  - Запуск воспроизводимых бенчмарков для сравнения CPU/NEON и AMX режимов.
...
- Логи и отчеты: Консольный вывод результатов работы тензорного принтера (tensor_printer.hpp) и итоговые таблицы сравнения CPU/NEON и AMX.
