...
В рамках работы сравниваются CPU/NEON- и AMX-исполнения, поддерживаются вещественные и квантованные представления различной
...
- тестирование корректности и бенчмаркинг CPU/NEON и AMX-путей исполнения.
...
![Сравнение времени выполнения матричного умножения CPU/NEON и AMX](docs/static/generated/cpu_amx_matmul_latency.svg)
