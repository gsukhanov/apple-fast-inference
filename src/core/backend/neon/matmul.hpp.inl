...
//        int16x8_t dst_register_7, dst_register_8;
    ...
    asm volatile (
        ...
        "umull %[dst_1].4s, %[lhs_1].4b, %[rhs_1].4b\n"
        "umull %[dst_1].4s, %[lhs_2].4b, %[rhs_2].4b\n"
        "umull %[dst_1].4s, %[lhs_3].4b, %[rhs_3].4b\n"
        "umull %[dst_1].4s, %[lhs_4].4b, %[rhs_4].4b\n"
        "umull %[dst_1].4s, %[lhs_5].4b, %[rhs_5].4b\n"
        "umull %[dst_1].4s, %[lhs_6].4b, %[rhs_6].4b\n"
        "umull %[dst_1].4s, %[lhs_7].4b, %[rhs_7].4b\n"
        "umull %[dst_1].4s, %[lhs_8].4b, %[rhs_8].4b\n"

        "umull %[dst_2].4s, %[lhs_1].4b, %[rhs_1].4b\n"
        "umull %[dst_2].4s, %[lhs_2].4b, %[rhs_2].4b\n"
        "umull %[dst_2].4s, %[lhs_3].4b, %[rhs_3].4b\n"
        "umull %[dst_2].4s, %[lhs_4].4b, %[rhs_4].4b\n"
        "umull %[dst_2].4s, %[lhs_5].4b, %[rhs_5].4b\n"
        "umull %[dst_2].4s, %[lhs_6].4b, %[rhs_6].4b\n"
        "umull %[dst_2].4s, %[lhs_7].4b, %[rhs_7].4b\n"
        "umull %[dst_2].4s, %[lhs_8].4b, %[rhs_8].4b\n"

        "st1 {%[dst_1].4s}, [%[dst_ptr]]\n"
        "st1 {%[dst_2].4s}, [%[dst_ptr], #32]\n"

        "umull2 %[dst_1].4s, %[lhs_1].8b, %[rhs_1].8b\n"
        "umull2 %[dst_1].4s, %[lhs_2].8b, %[rhs_2].8b\n"
        "umull2 %[dst_1].4s, %[lhs_3].8b, %[rhs_3].8b\n"
        "umull2 %[dst_1].4s, %[lhs_4].8b, %[rhs_4].8b\n"
        "umull2 %[dst_1].4s, %[lhs_5].8b, %[rhs_5].8b\n"
        "umull2 %[dst_1].4s, %[lhs_6].8b, %[rhs_6].8b\n"
        "umull2 %[dst_1].4s, %[lhs_7].8b, %[rhs_7].8b\n"
        "umull2 %[dst_1].4s, %[lhs_8].8b, %[rhs_8].8b\n"

        "umull2 %[dst_2].4s, %[lhs_1].8b, %[rhs_1].8b\n"
        "umull2 %[dst_2].4s, %[lhs_2].8b, %[rhs_2].8b\n"
        "umull2 %[dst_2].4s, %[lhs_3].8b, %[rhs_3].8b\n"
        "umull2 %[dst_2].4s, %[lhs_4].8b, %[rhs_4].8b\n"
        "umull2 %[dst_2].4s, %[lhs_5].8b, %[rhs_5].8b\n"
        "umull2 %[dst_2].4s, %[lhs_6].8b, %[rhs_6].8b\n"
        "umull2 %[dst_2].4s, %[lhs_7].8b, %[rhs_7].8b\n"
        "umull2 %[dst_2].4s, %[lhs_8].8b, %[rhs_8].8b\n"
...
//        int16x8_t dst_register_7, dst_register_8;
    ...
    asm volatile (
        ...
        "umlal %[dst_1].4s, %[rhs_1].4b, %[lhs_1].4b\n"
        "umlal %[dst_1].4s, %[rhs_2].4b, %[lhs_2].4b\n"
        "umlal %[dst_1].4s, %[rhs_3].4b, %[lhs_3].4b\n"
        "umlal %[dst_1].4s, %[rhs_4].4b, %[lhs_4].4b\n"
        "umlal %[dst_1].4s, %[rhs_5].4b, %[lhs_5].4b\n"
        "umlal %[dst_1].4s, %[rhs_6].4b, %[lhs_6].4b\n"
        "umlal %[dst_1].4s, %[rhs_7].4b, %[lhs_7].4b\n"
        "umlal %[dst_1].4s, %[rhs_8].4b, %[lhs_8].4b\n"

        "umlal %[dst_2].4s, %[rhs_1].4b, %[lhs_1].4b\n"
        "umlal %[dst_2].4s, %[rhs_2].4b, %[lhs_2].4b\n"
        "umlal %[dst_2].4s, %[rhs_3].4b, %[lhs_3].4b\n"
        "umlal %[dst_2].4s, %[rhs_4].4b, %[lhs_4].4b\n"
        "umlal %[dst_2].4s, %[rhs_5].4b, %[lhs_5].4b\n"
        "umlal %[dst_2].4s, %[rhs_6].4b, %[lhs_6].4b\n"
        "umlal %[dst_2].4s, %[rhs_7].4b, %[lhs_7].4b\n"
        "umlal %[dst_2].4s, %[rhs_8].4b, %[lhs_8].4b\n"

        "umlal2 %[dst_1].4s, %[rhs_1].8b, %[lhs_1].8b\n"
        "umlal2 %[dst_1].4s, %[rhs_2].8b, %[lhs_2].8b\n"
        "umlal2 %[dst_1].4s, %[rhs_3].8b, %[lhs_3].8b\n"
        "umlal2 %[dst_1].4s, %[rhs_4].8b, %[lhs_4].8b\n"
        "umlal2 %[dst_1].4s, %[rhs_5].8b, %[lhs_5].8b\n"
        "umlal2 %[dst_1].4s, %[rhs_6].8b, %[lhs_6].8b\n"
        "umlal2 %[dst_1].4s, %[rhs_7].8b, %[lhs_7].8b\n"
        "umlal2 %[dst_1].4s, %[rhs_8].8b, %[lhs_8].8b\n"

        "umlal2 %[dst_2].4s, %[rhs_1].8b, %[lhs_1].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_2].8b, %[lhs_2].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_3].8b, %[lhs_3].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_4].8b, %[lhs_4].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_5].8b, %[lhs_5].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_6].8b, %[lhs_6].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_7].8b, %[lhs_7].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_8].8b, %[lhs_8].8b\n"
...
inline void KernelMxM(int32_t* dst_data, int8_t* lhs_data, int8_t* rhs_data) {
    ...
    int16x8_t dst_register_7, dst_register_8, dst_register_9;
        ...
        "umlal %[dst_2].4s, %[rhs_5].4b, %[lhs_1].4b\n"
        "umlal %[dst_2].4s, %[rhs_6].4b, %[lhs_2].4b\n"
        "umlal %[dst_2].4s, %[rhs_7].4b, %[lhs_3].4b\n"
        "umlal %[dst_2].4s, %[rhs_8].4b, %[lhs_4].4b\n"

        "umlal2 %[dst_2].4s, %[rhs_5].8b, %[lhs_1].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_6].8b, %[lhs_2].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_7].8b, %[lhs_3].8b\n"
        "umlal2 %[dst_2].4s, %[rhs_8].8b, %[lhs_4].8b\n"

        "umlal %[dst_3].4s, %[rhs_9].4b, %[lhs_1].4b\n"
        "umlal %[dst_3].4s, %[rhs_10].4b, %[lhs_2].4b\n"
        "umlal %[dst_3].4s, %[rhs_11].4b, %[lhs_3].4b\n"
        "umlal %[dst_3].4s, %[rhs_12].4b, %[lhs_4].4b\n"

        "umlal2 %[dst_3].4s, %[rhs_9].8b, %[lhs_1].8b\n"
        "umlal2 %[dst_3].4s, %[rhs_10].8b, %[lhs_2].8b\n"
        "umlal2 %[dst_3].4s, %[rhs_11].8b, %[lhs_3].8b\n"
        "umlal2 %[dst_3].4s, %[rhs_12].8b, %[lhs_4].8b\n"

        "umlal %[dst_4].4s, %[rhs_1].4b, %[lhs_5].4b\n"
        "umlal %[dst_4].4s, %[rhs_2].4b, %[lhs_6].4b\n"
        "umlal %[dst_4].4s, %[rhs_3].4b, %[lhs_7].4b\n"
        "umlal %[dst_4].4s, %[rhs_4].4b, %[lhs_8].4b\n"

        "umlal2 %[dst_4].4s, %[rhs_1].8b, %[lhs_5].8b\n"
        "umlal2 %[dst_4].4s, %[rhs_2].8b, %[lhs_6].8b\n"
        "umlal2 %[dst_4].4s, %[rhs_3].8b, %[lhs_7].8b\n"
        "umlal2 %[dst_4].4s, %[rhs_4].8b, %[lhs_8].8b\n"

        "umlal %[dst_5].4s, %[rhs_5].4b, %[lhs_5].4b\n"
        "umlal %[dst_5].4s, %[rhs_6].4b, %[lhs_6].4b\n"
        "umlal %[dst_5].4s, %[rhs_7].4b, %[lhs_7].4b\n"
        "umlal %[dst_5].4s, %[rhs_8].4b, %[lhs_8].4b\n"

        "umlal2 %[dst_5].4s, %[rhs_5].8b, %[lhs_5].8b\n"
        "umlal2 %[dst_5].4s, %[rhs_6].8b, %[lhs_6].8b\n"
        "umlal2 %[dst_5].4s, %[rhs_7].8b, %[lhs_7].8b\n"
        "umlal2 %[dst_5].4s, %[rhs_8].8b, %[lhs_8].8b\n"

        "umlal %[dst_6].4s, %[rhs_9].4b, %[lhs_5].4b\n"
        "umlal %[dst_6].4s, %[rhs_10].4b, %[lhs_6].4b\n"
        "umlal %[dst_6].4s, %[rhs_11].4b, %[lhs_7].4b\n"
        "umlal %[dst_6].4s, %[rhs_12].4b, %[lhs_8].4b\n"

        "umlal2 %[dst_6].4s, %[rhs_9].8b, %[lhs_5].8b\n"
        "umlal2 %[dst_6].4s, %[rhs_10].8b, %[lhs_6].8b\n"
        "umlal2 %[dst_6].4s, %[rhs_11].8b, %[lhs_7].8b\n"
        "umlal2 %[dst_6].4s, %[rhs_12].8b, %[lhs_8].8b\n"


        "umlal %[dst_7].4s, %[rhs_1].4b, %[lhs_9].4b\n"
        "umlal %[dst_7].4s, %[rhs_2].4b, %[lhs_10].4b\n"
        "umlal %[dst_7].4s, %[rhs_3].4b, %[lhs_11].4b\n"
        "umlal %[dst_7].4s, %[rhs_4].4b, %[lhs_12].4b\n"

        "umlal2 %[dst_7].4s, %[rhs_1].8b, %[lhs_9].8b\n"
        "umlal2 %[dst_7].4s, %[rhs_2].8b, %[lhs_10].8b\n"
        "umlal2 %[dst_7].4s, %[rhs_3].8b, %[lhs_11].8b\n"
        "umlal2 %[dst_7].4s, %[rhs_4].8b, %[lhs_12].8b\n"

        "umlal %[dst_8].4s, %[rhs_5].4b, %[lhs_9].4b\n"
        "umlal %[dst_8].4s, %[rhs_6].4b, %[lhs_10].4b\n"
        "umlal %[dst_8].4s, %[rhs_7].4b, %[lhs_11].4b\n"
        "umlal %[dst_8].4s, %[rhs_8].4b, %[lhs_12].4b\n"

        "umlal2 %[dst_8].4s, %[rhs_5].8b, %[lhs_9].8b\n"
        "umlal2 %[dst_8].4s, %[rhs_6].8b, %[lhs_10].8b\n"
        "umlal2 %[dst_8].4s, %[rhs_7].8b, %[lhs_11].8b\n"
        "umlal2 %[dst_8].4s, %[rhs_8].8b, %[lhs_12].8b\n"

        "umlal %[dst_9].4s, %[rhs_9].4b, %[lhs_9].4b\n"
        "umlal %[dst_9].4s, %[rhs_10].4b, %[lhs_10].4b\n"
        "umlal %[dst_9].4s, %[rhs_11].4b, %[lhs_11].4b\n"
        "umlal %[dst_9].4s, %[rhs_12].4b, %[lhs_12].4b\n"

        "umlal2 %[dst_9].4s, %[rhs_9].8b, %[lhs_9].8b\n"
        "umlal2 %[dst_9].4s, %[rhs_10].8b, %[lhs_10].8b\n"
        "umlal2 %[dst_9].4s, %[rhs_11].8b, %[lhs_11].8b\n"
        "umlal2 %[dst_9].4s, %[rhs_12].8b, %[lhs_12].8b\n"
